#language: en
@FALL
Feature: TFS Enrollemt Scenarios with IRN Card
...
Scenario: Perform TFS enrollment with only excluded dept Items
	...
	And I Perform IRN Transaction for TFS enrollment
	    |requestMethod	|requestFile			   							|responseFile|
	...
	And I Perform IRN Transaction for TFS DisEnrollment
	    |requestMethod	|requestFile			   				|responseFile|
...
Scenario: Perform TFS enrollment with only non excluded dept Items
	...
	Then I Perform IRN Transaction for TFS enrollment
	    |requestMethod	|requestFile			   								|responseFile|
